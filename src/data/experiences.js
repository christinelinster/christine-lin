const experiences = [
  {
    ...
    period: "2025 - Present",
    overview: "",
    description: [`Developing custom business websites for retail clients using React, implementing responsive design and modern UI/UX patterns
`, `Collaborating with clients on requirements gathering and design iteration, translating business needs into technical solutions`],
    links:[],
  ...
  },
  {
    ...
    description: [
      ...
      `Defined solution positioning and technical documentation for
        Pulse, an observability platform,
